<?php 
  ...
  $profRepo = new Professeur();
  $prof = $profRepo->findByMail($_SESSION["user"]["mail"]);
    ...
    <aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
      <div class="py-4 text-gray-500 dark:text-gray-400">
       &nbsp;&nbsp;Bonjour <?=$prof["nom_prof"]?>,
        ...
        <li class="relative px-6 py-3">
            <button
              class="inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" aria-haspopup="true">
          ...
          <li class="relative px-6 py-3">
            <button
              ...
              <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round"
                ...
                <span class="ml-4">Seances à suivre</span>
              </span>
              <svg class="w-4 h-4" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd"
                  d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
            ...
            <div>
              <ul x-transition:enter="transition-all ease-in-out duration-300"
                ...
                #Recuperation de la liste des séances
                  $seanceRepo = new SeanceRepo();
                  $seance = $seanceRepo->findSeanceActive($prof["id_prof"]);
                  foreach($seance as $it){
                    ?>
                      <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
          ...
          $('#cc').append(
            ...
            `
              <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <style>
                      .note{
                        padding:2px;text-align:center;border:1px solid black;
                      }
                    </style>
